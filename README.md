...
Note: this will not work to produce a Venn diagram on [mybinder.org](http://mybinder.org) because of issues with `matplotlib` despite the fact the image is set to be saved as a file by default.  
