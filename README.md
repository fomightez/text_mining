...
Note: The core of this script and related code can produce a Venn diagram on [mybinder.org](http://mybinder.org)-derived if  `%matplotlib notebook` or `%matplotlib inline` is invoked as the first line, see [this demo](https://gist.github.com/fomightez/5575a91be88955257ba1f658ff253197).  
