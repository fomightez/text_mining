...
A related script, `find_overlap_in_lists_with_Venn.py`, (see below) will do all this script will do plus when comparing 2, 3, or 4 lists it depict the relationships among the lists in a Venn diagram.
